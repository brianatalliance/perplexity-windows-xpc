...
# Primary command
Set-Alias -Name Summon-Aunties -Value Invoke-XPC                     -Scope Global
Set-Alias -Name sa             -Value Invoke-XPC                     -Scope Global
...
function Show-XPCHelp {
    ...
    if ($Aliases -or $Full) {
        ...
        Write-Host ('    {0,-16} {1}' -f 'Summon-Aunties', 'PRIMARY - Query or help (alias: sa)') -ForegroundColor Magenta
        Write-Host ('    {0,-16} {1}' -f 'sa', 'Short for Summon-Aunties') -ForegroundColor Magenta
        Write-Host ('    {0,-16} {1}' -f '---', '---') -ForegroundColor DarkGray
        Write-Host ('    {0,-16} {1}' -f 'pplx', 'Invoke-Perplexity') -ForegroundColor Cyan
        Write-Host ('    {0,-16} {1}' -f 'pplxcode', 'Invoke-PerplexityCodeReview') -ForegroundColor Cyan
        Write-Host ('    {0,-16} {1}' -f 'pplxnet', 'Invoke-PerplexityNetDiag') -ForegroundColor Cyan
        Write-Host ('    {0,-16} {1}' -f 'pplxevt', 'Invoke-PerplexityEventAnalysis') -ForegroundColor Cyan
        Write-Host ('    {0,-16} {1}' -f 'pplxclip', 'Invoke-PerplexityClipboard') -ForegroundColor Cyan
        Write-Host ('    {0,-16} {1}' -f 'pplxerr', 'Ask-LastError') -ForegroundColor Cyan
        Write-Host ('    {0,-16} {1}' -f 'pplxhelp', 'Show-XPCHelp') -ForegroundColor Cyan
        Write-Host ('    {0,-16} {1}' -f 'xpc', 'Invoke-XPC') -ForegroundColor Cyan
        Write-Host ('    {0,-16} {1}' -f 'pplxdeep', 'Invoke-PerplexityDeepResearch') -ForegroundColor Cyan
        Write-Host ('    {0,-16} {1}' -f 'pplxthink', 'Invoke-PerplexityReasoning') -ForegroundColor Cyan
        Write-Host ('    {0,-16} {1}' -f 'pplxacad', 'Invoke-PerplexityAcademic') -ForegroundColor Cyan
        Write-Host ('    {0,-16} {1}' -f 'pplxsec', 'Invoke-PerplexitySecurityAnalysis') -ForegroundColor Cyan
        Write-Host ''
    ...
    $categories = [ordered]@{
        ...
        files = @{
            Title = 'File Analysis (Data Forensics)'
            Color = 'Yellow'
            Commands = @(
        ...
        batch = @{
            Title = 'Batch & Research (Research Institute)'
            Color = 'Blue'
            Commands = @(
        ...
        office = @{
            Title = 'Office Integration (Telepresence)'
            Color = 'DarkYellow'
            Commands = @(
        ...
        windows = @{
            Title = 'Windows Native (The Jackpot)'
            Color = 'White'
            Commands = @(
        ...
        clipboard = @{
            Title = 'Clipboard & Notifications (Haptic Drift)'
            Color = 'Magenta'
            Commands = @(
        ...
        premium = @{
            Title = 'Premium / The Klept (Enterprise Max)'
            Color = 'DarkMagenta'
            Commands = @(
    ...
    Write-Host '    _____                                        ___             __  _         ' -ForegroundColor DarkMagenta
    Write-Host '   / ___/__ ____ _  __ _  ___  ___  ___ _       / _ |__ _____  / /_(_)__ ___  ' -ForegroundColor DarkMagenta
    Write-Host '   \__ \/ // /  '' \/  '' \/ _ \/ _ \/ _ `/______/ __ / // / _ \/ __/ / -_|_-<  ' -ForegroundColor DarkMagenta
    Write-Host '  /____/\_,_/_/_/_/_/_/_/\___/_//_/\_,_/______/_/ |_\_,_/_//_/\__/_/\__/___/  ' -ForegroundColor DarkMagenta
    Write-Host '' -ForegroundColor DarkGray
    Write-Host '  "The Aunties see everything. They just needed someone to ask."' -ForegroundColor DarkGray
    Write-Host '                                     - The Peripheral' -ForegroundColor DarkGray
    Write-Host '  ====================================================' -ForegroundColor Magenta
    Write-Host "  Summon-Aunties v${ver}  |  Powered by Perplexity Sonar API" -ForegroundColor Magenta
    Write-Host '  ====================================================' -ForegroundColor Magenta
    Write-Host ''
    Write-Host '  Usage: Summon-Aunties "your question"   or   sa "your question"' -ForegroundColor White
    Write-Host '  Help:  Summon-Aunties -h                or   sa -h' -ForegroundColor White
    Write-Host ''
    ...
    Write-Host '    Summon-Aunties "query"             Ask Perplexity anything' -ForegroundColor DarkGray
    Write-Host '    sa -h                              This help page' -ForegroundColor DarkGray
    Write-Host '    sa -h -Category premium            Show premium commands' -ForegroundColor DarkGray
    Write-Host '    sa -h -Command DeepResearch         Detailed help for a command' -ForegroundColor DarkGray
    Write-Host '    sa -h -Examples                     Show all with examples' -ForegroundColor DarkGray
    Write-Host '    sa -h -Aliases                      Show alias table' -ForegroundColor DarkGray
    Write-Host ''
    Write-Host ('  {0} commands  |  {1} categories  |  github.com/brianatalliance/perplexity-windows-xpc' -f (Get-Command -Module PerplexityXPC).Count, $categories.Count) -ForegroundColor DarkGray
    Write-Host ''
}
