...
- **System tray application** - `Ctrl+Shift+A` global hotkey opens a floating query popup with dark/light theme support
...
The floating query popup triggered by Ctrl+Shift+A, showing a dark-mode response from Perplexity.
