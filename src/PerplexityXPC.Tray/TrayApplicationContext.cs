...
public sealed class TrayApplicationContext : ApplicationContext
{
    ...
    public TrayApplicationContext()
    {
        ...
        _iconGreen  = CreateCircleIcon(Color.FromArgb(0x4C, 0xAF, 0x50));
        _iconYellow = CreateCircleIcon(Color.FromArgb(0xFF, 0xC1, 0x07));
        _iconRed    = CreateCircleIcon(Color.FromArgb(0xF4, 0x43, 0x36));
